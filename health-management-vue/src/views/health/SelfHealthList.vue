<template>
    <div style="display: flex;flex-direction: column;align-items: center">
        ...
        <el-dialog title="查看学生健康档案"
            ...
            <health-table :health-data="checkInfoData" :is-msg="false" :disabled="disable" @save-suggestion="saveSuggestion"></health-table>
        </el-dialog>
    </div>
</template>
        ...
        methods:{
            ...
            judgeCheckIsExist(){
                if(this.checkInfoData.checkYear === "" || this.checkInfoData.checkYear == null){
                    ...
                    this.$http.get("/checkInfo/judgeCheckIsExist",{params:{"userId":this.user.id,"checkYear":this.checkInfoData.checkYear}}).then(res=>{
                        if (res.status === 200){
                            if (res.data===false){
